...
[*] [b]共用アイコン[/b]：20 種のモノクロアイコン（サイドバー、フォルダ、ドキュメント、開閉、言語、再読み込み、サイズリセット、検索、レイヤー、ピン、地球、スライダー、ゲージ、ロック、ロック解除、閉じる、位置特定、コピーなど）。配色に合わせて着色され、アイコン素材が無い場合は呼び出し側が文字表示へフォールバックします
